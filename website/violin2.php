...
<body>
    ...
    <div class="contain">
        <ul class="thumb">
            <li><button id="button1" onclick="change()" style="background-color:orange;"><img class="instrument" src="images/violin2_1.jpeg"></button></li>
            <li><button id="button2" onclick="change1()"><img class="instrument" src="images/violin2_2.jpeg"></button></li>
            <li><button id="button3" onclick="change2()"><img class="instrument" src="images/violin2_3.jpeg"></button></li>
        </ul>
        <div class="imgBox"><img id="main" src="images/violin2_1.jpeg"></div>
    </div>
    <div class="buy">
        <a href="creditviolin2.php" class="buynow">BUY NOW</a>
    </div>
    <div class="description">
        <h1>Blueberry V-20-MA ( Imported ) 4/4 Classical (Modern) Violin</h1>
        <h1>₹3999</h1>
        <h2>Description</h2>
        <p>Blueberry V-20 is completely hand crafted by senior luthiers with a solid Spruce top and maple back, sides and scroll. It is fitted with a hardwood fingerboard, pegs and chin rest, and an alloy tailpiece with four integrated fine tuners. This
            violin includes a lightweight form case, a bow, an adjustable shoulder rest with soft foam padding, bridge, this package ideal for beginners. Finesh : High Gloss</p>
    ...
    <div style="background-color: black;position:absolute;top:230%;">
        <br>
        <br>
        <footer>
            <table width="100%">
    ...
    <script>
        function change() {
            document.getElementById("main").src = "images/violin2_1.jpeg";
        ...
        function change1() {
            document.getElementById("main").src = "images/violin2_2.jpeg";
        ...
        function change2() {
            document.getElementById("main").src = "images/violin2_3.jpeg";
            document.getElementById("button1").style.backgroundColor = "transparent";
            document.getElementById("button2").style.backgroundColor = "transparent";
