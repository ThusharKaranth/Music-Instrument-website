...
<ul class="navbar">
    ...
    <div class="contain">
        <ul class="thumb">
            <li><button id="button1" onclick="change()" style="background-color:orange;"><img class="instrument" src="images/guitar6_1.jpeg"></button></li>
            <li><button id="button2" onclick="change1()"><img class="instrument" src="images/guitar6_2.jpeg"></button></li>
            <li><button id="button3" onclick="change2()"><img class="instrument" src="images/guitar6_3.jpeg"></button></li>
        </ul>
        <div class="imgBox"><img id="main" src="images/guitar6_1.jpeg"></div>
    </div>
    <div class="buy">
        <a href="creditguitar6.php" class="buynow">BUY NOW</a>
    </div>
    <div class="description">
        <h1>Blueberry B-40Y-Black, 40" Spruce Acoustic Guitar</h1>
        <h1>₹4999</h1>
        <h2>Description</h2>
        <p>Blueberry Deigned B-40Y, 40” Cutway guitar innovative design to produce good quality sound, Its Great quality and impeccable styling are just some of the features. It is manufactured by a leading brand, material used - Top made from Spruce wood,
            Side & Back made from linden wood, Fingerboard made from Ebony Engineered Wood, bridge material is made from Rosewood& Ebony Engineered Wood, its neck material is made from Catalpa wood, Machine head:Chrome die cast, Binding: ABS, Finish:
            Matt, Truss Rod for better adjustment of Guitar Action</p>
    ...
    <script>
        function change() {
            document.getElementById("main").src = "images/guitar6_1.jpeg";
        ...
        function change1() {
            document.getElementById("main").src = "images/guitar6_2.jpeg";
        ...
        function change2() {
            document.getElementById("main").src = "images/guitar6_3.jpeg";
            document.getElementById("button1").style.backgroundColor = "transparent";
            document.getElementById("button2").style.backgroundColor = "transparent";
