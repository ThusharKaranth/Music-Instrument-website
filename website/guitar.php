...
<head>
    ...
    <style>
        ...
        * {
        ...
        .hero-image {
            background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("images/headguitar.png");
            height: 50%;
...
<body>
    ...
    <div class="row">
        <div class="column">
            <div class="content">
                <a href="guitar1.php"><img src="images/guitar1_1.jpeg" alt="guitar" width="60%" height="145%"></a>
                <h3>Yamaha F310 Rosewood Acoustic Guitar </h3>
                <p>₹9,999</p>
                <a href="guitar1.php"><button id="btn">BUY</button></a>
            </div>
        </div>
        <div class="column">
            <div class="content">
                <a href="guitar2.php"><img src="images/guitar2_1.jpeg" alt="acoustic" width="60%" height="138%"></a>
                <h3>Blueberry B-D38-Blue, 38" Linden Wood Acoustic Guitar</h3>
                <p>₹3,900</p>
                <a href="guitar2.php"><button id="btn">BUY</button></a>
            </div>
        </div>
        <div class="column">
            <div class="content">
                <a href="guitar3.php"><img src="images/guitar3_1.jpeg" alt="electric" width="60%" height="139%"></a>
                <h3>Kadence KAD-A-05-EQ Tonewood Acoustic Guitar</h3>
                <p>₹8,599</p>
                <a href="guitar3.php"><button id="btn">BUY</button></a>
            </div>
        </div>
        <div class="column">
            <div class="content">
                <a href="guitar4.php"><img src="images/guitar4_1.jpeg" alt="guitar" width="60%" height="148.5%"></a>
                <h3>Givson Venus Rose Rosewood Semi-acoustic Guitar </h3>
                <p>₹5,499</p>
                <a href="guitar4.php"><button id="btn">BUY</button></a>
            </div>
        </div>
        <div class="column">
            <div class="content">
                <a href="guitar5.php"><img src="images/guitar5_1.jpeg" alt="guitar" width="60%" height="156%"></a>
                <h3>Kadence AVI03 Mahogany Acoustic Guitar </h3>
                <p>₹7,999</p>
                <a href="guitar5.html"><button id="btn">BUY</button></a>
            </div>
        </div>
        <div class="column">
            <div class="content">
                <a href="guitar6.php"><img src="images/guitar6_1.jpeg" alt="guitar" width="60%" height="149%"></a>
                <h3>Blueberry B-40Y-Black, 40" Spruce Acoustic Guitar </h3>
                <p>₹4,999</p>
                <a href="guitar6.php"><button id="btn">BUY</button></a>
            </div>
        </div>
    </div>
    <br><br><br>
