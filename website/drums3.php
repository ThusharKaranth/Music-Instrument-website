...
<body>
    ...
    <div class="contain">
        <ul class="thumb">
            <li><button id="button1" onclick="change()" style="background-color:orange;"><img class="instrument" src="images/drums3_1.jpeg"></button></li>
            <li><button id="button2" onclick="change1()"><img class="instrument" src="images/drums3_2.jpeg"></button></li>
            <li><button id="button3" onclick="change2()"><img class="instrument" src="images/drums3_3.jpeg"></button></li>
        </ul>
        <div class="imgBox"><img id="main" src="images/drums3_1.jpeg"></div>
    </div>
    <div class="buy">
        <a href="creditdrums3" class="buynow">BUY NOW</a>
    </div>
    <div class="description">
        <h1>Yamaha DD-65 Portable Electronic Drum Kit Electric 8 Drum Kit Set</h1>
        <h1>₹39,500</h1>
        <h2>Description</h2>
        <p>Yamaha DD65 Electronic Drum Pad Premium Package 8 Touch-sensitive drum pads allow expressive playing AUX in jack for connecting and playing along with an MP3 player Tempo control using Tap Start</p>
        ...
        <table cellspacing="30">
            ...
            <tr>
                <td>Model Number</td>
                <td>DD-65 Portable Electronic Drum Kit</td>
            </tr>
            <tr>
                <td>Type</td>
                <td>Electric</td>
    ...
    <script>
        function change() {
            document.getElementById("main").src = "images/drums3_1.jpeg";
        ...
        function change1() {
            document.getElementById("main").src = "images/drums3_2.jpeg";
        ...
        function change2() {
            document.getElementById("main").src = "images/drums3_3.jpeg";
            document.getElementById("button1").style.backgroundColor = "transparent";
            document.getElementById("button2").style.backgroundColor = "transparent";
