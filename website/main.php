...
<body>
    <ul>
        <li>
            <span><a href="main.php"><img src="images/logo.png" alt="" width="30px" height="30px">
    ...
    <div style="background-color:#292929;">
        ...
        <form action="main1.php" method="post">
            <center>
                ...
                <h1 style="font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;color:ffffff;">
                    <br><br>Welcome to <b>MUSIC LAB</b></h1>
                <h3 style="font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;color: #ffa500;">
                ...
                <span class="container" style="background-blend-mode: color">
