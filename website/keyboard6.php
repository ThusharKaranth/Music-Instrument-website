...
<div class="banner">
    ...
    <div class="contain">
        <ul class="thumb">
            <li><button id="button1" onclick="change()" style="background-color:orange;"><img class="instrument" src="images/keyboard6_1.jpeg"></button></li>
            <li><button id="button2" onclick="change1()"><img class="instrument" src="images/keyboard6_2.jpeg"></button></li>
            <li><button id="button3" onclick="change2()"><img class="instrument" src="images/keyboard6_3.jpeg"></button></li>
        </ul>
    <div class="imgBox"><img id="main" src="images/keyboard6_1.jpeg"></div>
    </div>
    <div class="buy">
        <a href="creditkeyboard6.php" class="buynow">BUY NOW</a>
    </div>
    <div class="description">
        <h1>Casio SA-78 KM17 Digital Portable Keyboard  (44 Keys)</h1>
        <h1>₹4,000</h1>
        <h2>Description</h2>
        <p> What can be more joyful for parents than seeing their child play their own compositions? Introduce your child to the soothing notes of music by bringing home this digital portable keyboard from Casio. It comes with features such as 44 mini-sized keys and a clear LCD Display to make your child's first musical instrument an easy one to operate.</p><h2>Specifications</h2>
        <h3>General</h3>
    ...
    <script>
        function change() {
                document.getElementById("main").src="images/keyboard6_1.jpeg";
        ...
        function change1() {
                document.getElementById("main").src="images/keyboard6_2.jpeg";
        ...
        function change2() {
                document.getElementById("main").src="images/keyboard6_3.jpeg";
                document.getElementById("button1").style.backgroundColor="transparent";
                document.getElementById("button2").style.backgroundColor="transparent";
