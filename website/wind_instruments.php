...
<head>
    ...
    <style>
        ...
        * {
        ...
        .hero-image {
            background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("images/headwindinstruments.jpeg");
            height: 50%;
...
<body>
    ...
    <div class="row">
        <div class="column">
            <div class="content">
                <a href="wind_instruments1.php"><img src="images/wind_instruments1_1.jpeg" alt="guitar" width="60%" height="90%"></a>
                <h3>Kadence KXC KAD-SAX-KXB Alto Saxophone (Black, Sax Case Included) </h3>
                <p>₹41,748</p>
                <a href="wind_instruments1.php"><button id="btn">BUY</button></a>
            </div>
        </div>
        <div class="column">
            <div class="content">
                <a href="wind_instruments2.php"><img src="images/wind_instruments2_1.jpeg" alt="acoustic" width="60%" height="100%"></a>
                <h3>Kadence Plated Flute (43 cm)</h3>
                <p>₹14,700</p>
                <a href="wind_instruments2.php"><button id="btn">BUY</button></a>
            </div>
        </div>
        <div class="column">
            <div class="content">
                <a href="wind_instruments6.php"><img src="images/wind_instruments6_1.jpeg" alt="guitar" width="60%" height="100%"></a>
                <h3>basuri 16 SOUNDS TRUCK HORN Alto Horn </h3>
                <p>₹4,050</p>
                <a href="wind_instruments6.php"><button id="btn">BUY</button></a>
            </div>
        </div>
        <div class="column">
            <div class="content">
                <a href="wind_instruments3.php"><img src="images/wind_instruments3_1.jpeg" alt="guitar" width="60%" height="85%"></a>
                <h3>Punam Flutes E Natural Base Bamboo Flute Bansuri Right Hand Player with Free Carry Case - Wood (30 inch) </h3>
                <p>₹6,200</p>
                <a href="wind_instruments3.php"><button id="btn">BUY</button></a>
            </div>
        </div>
        <div class="column">
            <div class="content">
                <a href="wind_instruments4.php"><img src="images/wind_instruments4_1.jpeg" alt="guitar" width="60%" height="100%"></a>
                <h3>HOHNER CROSSOVER (Steel) </h3>
                <p>₹5,900</p>
                <a href="wind_instruments4.php"><button id="btn">BUY</button></a>
            </div>
        </div>
        <div class="column">
            <div class="content">
                <a href="wind_instruments5.php"><img src="images/wind_instruments5_1.jpeg" alt="electric" width="60%" height="100%"></a>
                <h3>nasir ali NACASF12 Bb Trumpet (NICKEL) </h3>
                <p>₹5,898</p>
                <a href="wind_instruments5.php"><button id="btn">BUY</button></a>
            </div>
        </div>
    </div>
