        ...
        <div class="col-12 col-sm-8 col-md-6 col-lg-4 mx-auto">
            <div id="pay-invoice" class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form action="guitar6.php" method="post" novalidate="novalidate" class="needs-validation">
                        ...
                        <div class="form-group">
                            ...
                            <input id="cc-payment" name="cc-payment" type="text" class="form-control" aria-required="true" aria-invalid="false" required value="4999">
                        ...
                        <div>
                                ...
                                <span id="payment-button-amount">Pay ₹4,999</span>
