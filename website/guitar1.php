...
<body>
    ...
    <div class="contain">
        <ul class="thumb">
            <li><button id="button1" onclick="change()" style="background-color:orange;"><img class="instrument" src="images/guitar1_1.jpeg"></button></li>
            <li><button id="button2" onclick="change1()"><img class="instrument" src="images/guitar1_2.jpeg"></button></li>
            <li><button id="button3" onclick="change2()"><img class="instrument" src="images/guitar1_3.jpeg"></button></li>
        </ul>
        <div class="imgBox"><img id="main" src="images/guitar1_1.jpeg"></div>
    </div>
    <div class="buy">
        <a href="creditguitar1.php,input[type=email]" class="buynow">BUY NOW</a>
    </div>
    <div class="description">
        <h1>Yamaha F310 Rosewood Acoustic Guitar</h1>
        <h1>₹9999</h1>
        <h2>Description</h2>
        <p>The Yamaha F310 acoustic folk guitar represents everything that you have come to expect from the world leader in musical instrument manufacturing.A spruce top, mahogany back and sides, and rosewood fingerboard come standard on this outstanding
            guitar. If you are looking for an amazing first guitar to fuel your creative fire then the F310 is the one for you.</p>
        ...
        <table cellspacing="30">
            ...
            <tr>
                <td>Model Name</td>
                <td>Yamaha F310 Acoustic Guitar 6-strings, Natural</td>
            </tr>
            <tr>
                <td>Neck Material</td>
                <td>Locally Sourced Tonewood</td>
            </tr>
        </table>
        <h3>Dimensions</h3>
        <table cellspacing="30">
    ...
    <script>
        function change() {
            document.getElementById("main").src = "images/guitar1_1.jpeg";
        ...
        function change1() {
            document.getElementById("main").src = "images/guitar1_2.jpeg";
        ...
        function change2() {
            document.getElementById("main").src = "images/guitar1_3.jpeg";
            document.getElementById("button1").style.backgroundColor = "transparent";
            document.getElementById("button2").style.backgroundColor = "transparent";
