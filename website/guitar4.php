...
<body>
    ...
    <div class="contain">
        <ul class="thumb">
            <li><button id="button1" onclick="change()" style="background-color:orange;"><img class="instrument" src="images/guitar4_1.jpeg"></button></li>
            <li><button id="button2" onclick="change1()"><img class="instrument" src="images/guitar4_2.jpeg"></button></li>
            <li><button id="button3" onclick="change2()"><img class="instrument" src="images/guitar4_3.jpeg"></button></li>
        </ul>
        <div class="imgBox"><img id="main" src="images/guitar4_1.jpeg"></div>
    </div>
    <div class="buy">
        <a href="creditguitar4.php" class="buynow">BUY NOW</a>
    </div>
    <div class="description">
        <h1>Givson Venus Rose Rosewood Semi-acoustic Guitar</h1>
        <h1>₹5499</h1>
        <h2>Description</h2>
        <p>Striking the perfect chord between functionality and style, this acoustic guitar from Signature is sure to be your favourite companion wherever you go. Striking Colour What makes this 6-stringed guitar stand apart, is its striking pure natural
            wood shade. What’s more, performing with this stunner on the stage will also add charm to your appeal.</p>
    ...
    <script>
        function change() {
            document.getElementById("main").src = "images/guitar4_1.jpeg";
        ...
        function change1() {
            document.getElementById("main").src = "images/guitar4_2.jpeg";
        ...
        function change2() {
            document.getElementById("main").src = "images/guitar4_3.jpeg";
            document.getElementById("button1").style.backgroundColor = "transparent";
            document.getElementById("button2").style.backgroundColor = "transparent";
