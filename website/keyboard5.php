...
<div class="banner">
    ...
    <div class="contain">
        <ul class="thumb">
            <li><button id="button1" onclick="change()" style="background-color:orange;"><img class="instrument" src="images/keyboard5_1.jpeg"></button></li>
            <li><button id="button2" onclick="change1()"><img class="instrument" src="images/keyboard5_2.jpeg"></button></li>
            <li><button id="button3" onclick="change2()"><img class="instrument" src="images/keyboard5_3.jpeg"></button></li>
        </ul>
    <div class="imgBox"><img id="main" src="images/keyboard5_1.jpeg"></div>
    </div>
    <div class="buy">
        <a href="creditkeyboard5.php" class="buynow">BUY NOW</a>
    </div>
    <div class="description">
        <h1>korg PA700 Korg PA-700 Professional Arranger Keyboard Digital Arranger Keyboard  (61 Keys)</h1>
        <h1>₹97,000</h1>
        <h2>Description</h2>
        <p> Polishing the music is necessary for making it sound exceptionally well. You can produce impressive music by using various built-in master effects that are provided in Korg PA 700. The final touch and polishing can be added so that you can be ready for your musical performance. Useful guitar mode The guitar mode, which is offered to the players is extremely beneficial. It helps in producing the sound which feels as if it is produced by using an actual guitar instead of a keyboard.</p>
        ...
        <table cellspacing="30">
            ...
            <tr>
                <td>Model Name</td>
                <td>Yamaha F310 Acoustic KEYBOARDS 6-strings, Natural</td>
            </tr>
            <tr>
                <td>Suitable For </td>
                <td>Intermediate</td>
    ...
    <div class="submitreview">
        ...
        <p><label for="email"><h2>Email</h2></label><p>
    ...
    <script>
        function change() {
                document.getElementById("main").src="images/keyboard5_1.jpeg";
        ...
        function change1() {
                document.getElementById("main").src="images/keyboard5_2.jpeg";
        ...
        function change2() {
                document.getElementById("main").src="images/keyboard5_3.jpeg";
                document.getElementById("button1").style.backgroundColor="transparent";
                document.getElementById("button2").style.backgroundColor="transparent";
