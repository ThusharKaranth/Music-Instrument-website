...
<body>
    ...
    <div class="contain">
        <ul class="thumb">
            <li><button id="button1" onclick="change()" style="background-color:orange;"><img class="instrument" src="images/guitar3_1.jpeg"></button></li>
            <li><button id="button2" onclick="change1()"><img class="instrument" src="images/guitar3_2.jpeg"></button></li>
            <li><button id="button3" onclick="change2()"><img class="instrument" src="images/guitar3_3.jpeg"></button></li>
        </ul>
        <div class="imgBox"><img id="main" src="images/guitar3_1.jpeg"></div>
    </div>
    <div class="buy">
        <a href="creditguitar3.php" class="buynow">BUY NOW</a>
    </div>
    <div class="description">
        <h1>Kadence KAD-A-05-EQ Tonewood Acoustic Guitar</h1>
        <h1>₹8599</h1>
        <h2>Description</h2>
        <p>From the house of Kadence comes the Acoustica series. These acoustic guitars are built to have great sound quality, high durability and increased ease of use for both beginners as well as professionals. The 39 inch stature makes it easy to handle
            and carry around without compromising on the sound quality. The selected Body woods allows for a high fidelity resonating hollow chamber and the rosewood fretboard makes is very durable with great sound carrying capabilities. If you are looking
            for a great quality acoustic guitar the Acosutic Series from Kadence is what you need</p>
    ...
    <div class="submitreview">
        ...
        <p><input class="review" name="name" type="text"></p>
    ...
    <script>
        function change() {
            document.getElementById("main").src = "images/guitar3_1.jpeg";
        ...
        function change1() {
            document.getElementById("main").src = "images/guitar3_2.jpeg";
        ...
        function change2() {
            document.getElementById("main").src = "images/guitar3_3.jpeg";
            document.getElementById("button1").style.backgroundColor = "transparent";
            document.getElementById("button2").style.backgroundColor = "transparent";
