...
<body>
    ...
    <div class="contain">
        <ul class="thumb">
            <li><button id="button1" onclick="change()" style="background-color:orange;"><img class="instrument" src="images/drums1_1.jpeg"></button></li>
            <li><button id="button2" onclick="change1()"><img class="instrument" src="images/drums1_2.jpeg"></button></li>
            <li><button id="button3" onclick="change2()"><img class="instrument" src="images/drums1_3.jpeg"></button></li>
        </ul>
        <div class="imgBox"><img id="main" src="images/drums1_1.jpeg"></div>
    </div>
    <div class="buy">
        <a href="creditdrums1.php" class="buynow">BUY NOW</a>
    </div>
    <div class="description">
        <h1>ROLAND TD-17KL Electric 1 Drum Kit Set (Professional)</h1>
        <h1>₹1,01,000</h1>
        ...
        <table cellspacing="30">
            ...
            <tr>
                <td>Model Name</td>
                <td>Yamaha F310 Acoustic DRUMS 6-strings, Natural</td>
            </tr>
            <tr>
                <td>Suitable For </td>
                <td>Professional</td>
    ...
    <script>
        function change() {
            document.getElementById("main").src = "images/drums1_1.jpeg";
        ...
        function change1() {
            document.getElementById("main").src = "images/drums1_2.jpeg";
        ...
        function change2() {
            document.getElementById("main").src = "images/drums1_3.jpeg";
            document.getElementById("button1").style.backgroundColor = "transparent";
            document.getElementById("button2").style.backgroundColor = "transparent";
