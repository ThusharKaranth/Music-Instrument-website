...
<body>
    ...
    <div class="contain">
        <ul class="thumb">
            <li><button id="button1" onclick="change()" style="background-color:orange;"><img class="instrument" src="images/violin6_1.jpeg"></button></li>
            <li><button id="button2" onclick="change1()"><img class="instrument" src="images/violin6_2.jpeg"></button></li>
            <li><button id="button3" onclick="change2()"><img class="instrument" src="images/violin6_3.jpeg"></button></li>
        </ul>
        <div class="imgBox"><img id="main" src="images/violin6_1.jpeg"></div>
    </div>
    <div class="buy">
        <a href="creditviolin6.php" class="buynow">BUY NOW</a>
    </div>
    <div class="description">
        <h1>Infinity 4/4 Classical (Modern) Violin </h1>
        <h1>₹7500</h1>
        <h2>Description</h2>
        <p>This Acoustic Violin set is made of maple wood. It is brown in colour and is a semi professional model.</p>
    ...
    <script>
        function change() {
            document.getElementById("main").src = "images/violin6_1.jpeg";
        ...
        function change1() {
            document.getElementById("main").src = "images/violin6_2.jpeg";
        ...
        function change2() {
            document.getElementById("main").src = "images/violin6_3.jpeg";
            document.getElementById("button1").style.backgroundColor = "transparent";
            document.getElementById("button2").style.backgroundColor = "transparent";
