            ...
            <tr>
                <td>
                    <div class="gallery" style="float:left;">
                        <a href="guitarcourse.php">
                            <img src="images\1.jpg" alt="Guitar Classes">
                        </a>
                        <div class="desc">Guitar Classes</div>
                    </div>
                </td>
                <td>
                    <div class="gallery" style="float: none;">
                        <a href="violincourse.php">
                            <img src="images\2.jpg" alt="Violin Classes" width="600" height="400">
                        </a>
                        <div class="desc">Violin Classes</div>
                    </div>
                </td>
                <td>
                    <div class="gallery" style="float: right;">
                        <a href="keyboardcourse.php">
                            <img src="images\3.jpg" alt="Keyboard Classes" width="600" height="400">
                        </a>
                        <div class="desc">Keyboard Classes</div>
                    </div>
                </td>
            </tr>
        </table>
