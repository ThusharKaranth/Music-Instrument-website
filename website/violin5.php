...
<body>
    ...
    <div class="contain">
        <ul class="thumb">
            <li><button id="button1" onclick="change()" style="background-color:orange;"><img class="instrument" src="images/violin5_1.jpeg"></button></li>
            <li><button id="button2" onclick="change1()"><img class="instrument" src="images/violin5_2.jpeg"></button></li>
            <li><button id="button3" onclick="change2()"><img class="instrument" src="images/violin5_3.jpeg"></button></li>
        </ul>
        <div class="imgBox"><img id="main" src="images/violin5_1.jpeg"></div>
    </div>
    <div class="buy">
        <a href="creditviolin5.php" class="buynow">BUY NOW</a>
    </div>
    <div class="description">
        <h1>Kadence KAD-VIV-VIV0109 4/4 Semi- Acoustic Violin </h1>
        <h1>₹5999</h1>
        <h2>Description</h2>
    ...
    <script>
        function change() {
            document.getElementById("main").src = "images/violin5_1.jpeg";
        ...
        function change1() {
            document.getElementById("main").src = "images/violin5_2.jpeg";
        ...
        function change2() {
            document.getElementById("main").src = "images/violin5_3.jpeg";
            document.getElementById("button1").style.backgroundColor = "transparent";
            document.getElementById("button2").style.backgroundColor = "transparent";
