...
<body>
    ...
    <div class="contain">
        <ul class="thumb">
            <li><button id="button1" onclick="change()" style="background-color:orange;"><img class="instrument" src="images/drums6_1.jpeg"></button></li>
            <li><button id="button2" onclick="change1()"><img class="instrument" src="images/drums6_2.jpeg"></button></li>
            <li><button id="button3" onclick="change2()"><img class="instrument" src="images/drums6_3.jpeg"></button></li>
        </ul>
        <div class="imgBox"><img id="main" src="images/drums6_1.jpeg"></div>
    </div>
    <div class="buy">
        <a href="creditdrums6.php" class="buynow">BUY NOW</a>
    </div>
    <div class="description">
        <h1>Behringer XD80USB Premium 8-Piece Electronic Drum Set)</h1>
        <h1>₹29,999</h1>
        <h2>Description</h2>
        <p>
            8-Piece electronic drum set with HDS240USB sound module Ships ready to rock with everything you need to start immediately 10 factory presets plus 5 user-programmable drum sets Large LCD and icon-driven user interface for easy operation USB and Midi interfaces
            to connect with any virtual instrument and drum software (not included) With 175 sounds, 15 drum sets and LCD display
        </p>
    ...
    <script>
        function change() {
            document.getElementById("main").src = "images/drums6_1.jpeg";
        ...
        function change1() {
            document.getElementById("main").src = "images/drums6_2.jpeg";
        ...
        function change2() {
            document.getElementById("main").src = "images/drums6_3.jpeg";
            document.getElementById("button1").style.backgroundColor = "transparent";
            document.getElementById("button2").style.backgroundColor = "transparent";
