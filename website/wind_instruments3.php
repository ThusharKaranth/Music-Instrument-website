...
<body>
    ...
    <div class="contain">
        <ul class="thumb">
            <li><button id="button1" onclick="change()" style="background-color:orange;"><img class="instrument" src="images/wind_instruments3_1.jpeg"></button></li>
            <li><button id="button2" onclick="change1()"><img class="instrument" src="images/wind_instruments3_2.jpeg"></button></li>
            <li><button id="button3" onclick="change2()"><img class="instrument" src="images/wind_instruments3_3.jpeg"></button></li>
        </ul>
        <div class="imgBox"><img id="main" src="images/wind_instruments3_1.jpeg"></div>
    </div>
    <div class="buy">
        <a href="creditwind_instruments3.php" class="buynow">BUY NOW</a>
    </div>
    <div class="description">
        <h1>Punam Flutes E Natural Base Bamboo Flute Bansuri Right Hand Player with Free Carry Case - Wood (30 inch)
        </h1>
        <h1>₹6,200</h1>
    ...
    <script>
        function change() {
            document.getElementById("main").src = "images/wind_instruments3_1.jpeg";
        ...
        function change1() {
            document.getElementById("main").src = "images/wind_instruments3_2.jpeg";
        ...
        function change2() {
            document.getElementById("main").src = "images/wind_instruments3_3.jpeg";
            document.getElementById("button1").style.backgroundColor = "transparent";
            document.getElementById("button2").style.backgroundColor = "transparent";
