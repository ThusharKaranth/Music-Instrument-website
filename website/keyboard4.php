...
<body>
    <ul class="navbar">
        <li class="label">
            <span><a href="#head"><img src="images/logo.png" alt="" width="30px" height="30px">
...
<div class="banner">
    ...
    <div class="contain">
        <ul class="thumb">
            <li><button id="button1" onclick="change()" style="background-color:orange;"><img class="instrument" src="images/keyboard4_1.jpeg"></button></li>
            <li><button id="button2" onclick="change1()"><img class="instrument" src="images/keyboard4_2.jpeg"></button></li>
            <li><button id="button3" onclick="change2()"><img class="instrument" src="images/keyboard4_3.jpeg"></button></li>
        </ul>
    <div class="imgBox"><img id="main" src="images/keyboard4_1.jpeg"></div>
    </div>
    <div class="buy">
        <a href="creditkeyboard4.php" class="buynow">BUY NOW</a>
    </div>
    <div class="description">
        <h1>Samson Graphite-25 USB MIDI Analog Portable Keyboard  (25 Keys)</h1>
        <h1 id = "trans">₹9,983</h1>
        <h2>Description</h2>
        <p> This keyboard not only comes with a number of tones and rhythms but it also features a large song bank which helps in practising and learning new songs. It also comes with other features such as MIDI Out, Auto Accompaniment, Metronome, 3-step Lessons, and a big LCD which make your keyboard-playing experience a true pleasure.</p>
...
<div class="submitreview">
    ...
    <script>
        ...
        function change() {
                document.getElementById("main").src="images/keyboard4_1.jpeg";
        ...
        function change1() {
                document.getElementById("main").src="images/keyboard4_2.jpeg";
        ...
        function change2() {
                document.getElementById("main").src="images/keyboard4_3.jpeg";
                document.getElementById("button1").style.backgroundColor="transparent";
                document.getElementById("button2").style.backgroundColor="transparent";
