...
<body>
    ...
    <div class="contain">
        <ul class="thumb">
            <li><button id="button1" onclick="change()" style="background-color:orange;"><img class="instrument" src="images/drums5_1.jpeg"></button></li>
            <li><button id="button2" onclick="change1()"><img class="instrument" src="images/drums5_2.jpeg"></button></li>
            <li><button id="button3" onclick="change2()"><img class="instrument" src="images/drums5_3.jpeg"></button></li>
        </ul>
        <div class="imgBox"><img id="main" src="images/drums5_1.jpeg"></div>
    </div>
    <div class="buy">
        <a href="creditdrums5" class="buynow">BUY NOW</a>
    </div>
    <div class="description">
        <h1>Sound X SX-100 5-Piece Acoustic 4 Drum Kit Set (Student)</h1>
        <h1>₹25,500</h1>
        ...
        <table cellspacing="30">
            ...
            <tr>
                <td>Set Contents</td>
                <td>Bass Drum, Toms, Snare Drum</td>
            </tr>
            <tr>
                <td>Color</td>
                <td>Red</td>
    ...
    <script>
        function change() {
            document.getElementById("main").src = "images/drums5_1.jpeg";
        ...
        function change1() {
            document.getElementById("main").src = "images/drums5_2.jpeg";
        ...
        function change2() {
            document.getElementById("main").src = "images/drums5_3.jpeg";
            document.getElementById("button1").style.backgroundColor = "transparent";
            document.getElementById("button2").style.backgroundColor = "transparent";
