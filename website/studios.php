...
<body>
    ...
    <div style="background-color: #292929;">
        ...
        <center>
            ...
            <h1 style="color: #808080;">Choose Your Location</h1>
            <div class="button" style="width: 90%;">
                <a href="bangalorestudios.php"><button class="button-side" style="width:40%;height:20%;"><span><h2>Banglore</h2></span></button></a>
                <a href="hyderabadstudios.php"><button class="button-side" style="width:40%;height: 20%;"><span><h2>Hyderabad</h2></span></button></a>

            </div>
            <div class="button" style="width:90%;">
                <a href="mumbaistudios.php"><button class="button-side" style="width:40%;height: 20%;"><span><h2>Mumbai</h2></span></button></a>
                <a href="delhistudios.php"><button class="button-side" style="width:40%;height: 20%;"><span><h2>Delhi</h2></span></button></a>
