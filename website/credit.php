                ...
                <div class="card-body">
                    ...
                    <form action="/echo" method="post" novalidate="novalidate" class="needs-validation">
                        ...
                        <div class="form-group">
                            ...
                            <input id="cc-payment" name="cc-payment" type="text" class="form-control" aria-required="true" aria-invalid="false" required value=<?php echo$_POST['price']; ?>>
                        ...
                        <div>
                            <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                ...
                                <span id="payment-button-amount">Pay <?php echo""?></span>
