...
<body>
    ...
    <div class="contain">
        <ul class="thumb">
            <li><button id="button1" onclick="change()" style="background-color:orange;"><img class="instrument" src="images/drums4_1.jpeg"></button></li>
            <li><button id="button2" onclick="change1()"><img class="instrument" src="images/drums4_2.jpeg"></button></li>
            <li><button id="button3" onclick="change2()"><img class="instrument" src="images/drums4_3.jpeg"></button></li>
        </ul>
        <div class="imgBox"><img id="main" src="images/drums4_1.jpeg"></div>
    </div>
    <div class="buy">
        <a href="creditdrums4" class="buynow">BUY NOW</a>
    </div>
    <div class="description">
        <h1>Zahuu ZHUU-0075 Electric 5 Drum Kit Set (Kids, Student)</h1>
        <h1>₹19,500</h1>
        ...
        <table cellspacing="30">
            ...
            <tr>
                <td>Set Contents</td>
                <td>Bass Drum, Drum Throne, Drumsticks</td>
            </tr>
            <tr>
                <td>Color</td>
                <td>Black</td>
    ...
    <script>
        function change() {
            document.getElementById("main").src = "images/drums4_1.jpeg";
        ...
        function change1() {
            document.getElementById("main").src = "images/drums4_2.jpeg";
        ...
        function change2() {
            document.getElementById("main").src = "images/drums4_3.jpeg";
            document.getElementById("button1").style.backgroundColor = "transparent";
            document.getElementById("button2").style.backgroundColor = "transparent";
