...
<body>
    ...
    <div class="contain">
        <ul class="thumb">
            <li><button id="button1" onclick="change()" style="background-color:orange;"><img class="instrument" src="images/drums2_1.jpeg"></button></li>
            <li><button id="button2" onclick="change1()"><img class="instrument" src="images/drums2_2.jpeg"></button></li>
            <li><button id="button3" onclick="change2()"><img class="instrument" src="images/drums2_3.jpeg"></button></li>
        </ul>
        <div class="imgBox"><img id="main" src="images/drums2_1.jpeg"></div>
    </div>
    <div class="buy">
        <a href="creditdrums2.php" class="buynow">BUY NOW</a>
    </div>
    <div class="description">
        <h1>Vidisa Electronic Drum Jazz Drum USB Roll Up Drum Kit</h1>
        <h1>₹30,599</h1>
        <h2>Description</h2>
        <p>
            * Features: Portable and fashionable, easy to carry. * Standard drum-set and the expansive pedal makes you feel absolutely the same as real drum. * Professional demo inside, convenient to study. Accompaniment inside, tempo adjustable, gives you the best
            way to study and practice. * With record function inside, convenient to record your inspiration anywhere anytime.
        </p>
    ...
    <script>
        function change() {
            document.getElementById("main").src = "images/drums2_1.jpeg";
        ...
        function change1() {
            document.getElementById("main").src = "images/drums2_2.jpeg";
        ...
        function change2() {
            document.getElementById("main").src = "images/drums2_3.jpeg";
            document.getElementById("button1").style.backgroundColor = "transparent";
            document.getElementById("button2").style.backgroundColor = "transparent";
